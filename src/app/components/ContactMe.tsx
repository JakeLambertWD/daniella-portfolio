...
import { Box, Button, Center, Flex, Group, Stack, Text, TextInput, Textarea, useMantineTheme } from "@mantine/core";
...
function ContactMe(props: any) {
  ...
  return (
    <Stack id="contactMeId" ref={props.contactMeRef} align="center" gap="xs" my="150px" className={sora.className}>
      <Text className={bodoniModa.className} fz="130px" c={theme.colors.persianPink[0]} mb="-30px">
        Touch Base
      </Text>
